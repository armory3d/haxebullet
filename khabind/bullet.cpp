...
HL_PRIM _ref(btGImpactMeshShape)* HL_NAME(btGImpactMeshShape_new1)(_ref(btStridingMeshInterface)* meshInterface) {
	return alloc_ref((new btGImpactMeshShape(_unref(meshInterface))),btGImpactMeshShape);
}
...
HL_PRIM void HL_NAME(btCollisionWorld_updateSingleAabb1)(_ref(btCollisionWorld)* _this, _ref(btCollisionObject)* colObj) {
	_unref(_this)->updateSingleAabb(_unref(colObj));
}
