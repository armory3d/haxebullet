...
#if hl
abstract ConeShapeZ(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btConeShapeZ_new2")
    static function new2(radius:Single, height:Single):ConeShapeZ return null;
    public inline function new(radius:Single, height:Single):Void this = new2(cast radius, cast height);
    @:hlNative("bullet", "btConeShapeZ_delete")
...
#elseif js
abstract ConeShapeZ(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new2(radius:Float, height:Float):ConeShapeZ return untyped bullet._eb_btConeShapeZ_new2(radius, height);
    public inline function new(radius:Float, height:Float):Void this = new2(cast radius, cast height);
    inline public function delete():Void return untyped bullet._eb_btConeShapeZ_delete(this);
    @:to
    inline function _toConeShape():ConeShape return cast this;
    @:to
    inline function _toCollisionShape():CollisionShape return cast this;
