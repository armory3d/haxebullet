...
#if hl
abstract TriangleMeshShape(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btTriangleMeshShape_delete")
...
#elseif js
abstract TriangleMeshShape(webidl.Types.Ref) to webidl.Types.Ref {
    inline public function delete():Void return untyped bullet._eb_btTriangleMeshShape_delete(this);
    @:to
    inline function _toConcaveShape():ConcaveShape return cast this;
    @:to
    inline function _toCollisionShape():CollisionShape return cast this;
