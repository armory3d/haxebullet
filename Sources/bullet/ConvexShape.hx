...
#if hl
abstract ConvexShape(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btConvexShape_delete")
...
#elseif js
abstract ConvexShape(webidl.Types.Ref) to webidl.Types.Ref {
    inline public function delete():Void return untyped bullet._eb_btConvexShape_delete(this);
    @:to
    inline function _toCollisionShape():CollisionShape return cast this;
