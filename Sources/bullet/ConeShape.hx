...
#if hl
abstract ConeShape(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btConeShape_new2")
    static function new2(radius:Single, height:Single):ConeShape return null;
    public inline function new(radius:Single, height:Single):Void this = new2(cast radius, cast height);
    @:hlNative("bullet", "btConeShape_delete")
...
#elseif js
abstract ConeShape(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new2(radius:Float, height:Float):ConeShape return untyped bullet._eb_btConeShape_new2(radius, height);
    public inline function new(radius:Float, height:Float):Void this = new2(cast radius, cast height);
    inline public function delete():Void return untyped bullet._eb_btConeShape_delete(this);
    @:to
    inline function _toCollisionShape():CollisionShape return cast this;
