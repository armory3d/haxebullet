...
#if hl
abstract GhostObject(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btGhostObject_new0")
    static function new0():GhostObject return null;
    ...
    @:hlNative("bullet", "btGhostObject_delete")
...
#elseif js
abstract GhostObject(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new0():GhostObject return untyped bullet._eb_btGhostObject_new0();
    public inline function new():Void this = new0();
    ...
    inline public function delete():Void return untyped bullet._eb_btGhostObject_delete(this);
    @:to
    inline function _toCollisionObject():CollisionObject return cast this;
