...
#if hl
abstract CapsuleShape(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btCapsuleShape_new2")
    static function new2(radius:Single, height:Single):CapsuleShape return null;
    public inline function new(radius:Single, height:Single):Void this = new2(cast radius, cast height);
    @:hlNative("bullet", "btCapsuleShape_setMargin1")
    public function setMargin(margin:Single):Void { }
    @:hlNative("bullet", "btCapsuleShape_getMargin0")
    public function getMargin():Single return 0.;
    @:hlNative("bullet", "btCapsuleShape_delete")
...
#elseif js
abstract CapsuleShape(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new2(radius:Float, height:Float):CapsuleShape return untyped bullet._eb_btCapsuleShape_new2(radius, height);
    public inline function new(radius:Float, height:Float):Void this = new2(cast radius, cast height);
    inline public function setMargin(margin:Float):Void return untyped bullet._eb_btCapsuleShape_setMargin1(this, margin);
    inline public function getMargin():Float return untyped bullet._eb_btCapsuleShape_getMargin0(this);
    inline public function delete():Void return untyped bullet._eb_btCapsuleShape_delete(this);
    @:to
    inline function _toCollisionShape():CollisionShape return cast this;
