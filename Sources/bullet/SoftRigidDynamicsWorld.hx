...
#if hl
abstract SoftRigidDynamicsWorld(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_new5")
    static function new5(dispatcher:Dispatcher, pairCache:BroadphaseInterface, constraintSolver:ConstraintSolver, collisionConfiguration:CollisionConfiguration, softBodySolver:SoftBodySolver):SoftRigidDynamicsWorld return null;
    public inline function new(dispatcher:Dispatcher, pairCache:BroadphaseInterface, constraintSolver:ConstraintSolver, collisionConfiguration:CollisionConfiguration, softBodySolver:SoftBodySolver):Void this = new5(cast dispatcher, cast pairCache, cast constraintSolver, cast collisionConfiguration, cast softBodySolver);
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_addSoftBody3")
    public function addSoftBody(body:SoftBody, collisionFilterGroup:hl.UI16, collisionFilterMask:hl.UI16):Void { }
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_removeSoftBody1")
    public function removeSoftBody(body:SoftBody):Void { }
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_removeCollisionObject1")
    public function removeCollisionObject(collisionObject:CollisionObject):Void { }
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_getWorldInfo0")
    public function getWorldInfo():SoftBodyWorldInfo return null;
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_getSoftBodyArray0")
    public function getSoftBodyArray():SoftBodyArray return null;
    @:hlNative("bullet", "btSoftRigidDynamicsWorld_delete")
    public function delete():Void { }
    @:to
    inline function _toDiscreteDynamicsWorld():DiscreteDynamicsWorld return cast this;
...
#elseif js
abstract SoftRigidDynamicsWorld(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new5(dispatcher:Dispatcher, pairCache:BroadphaseInterface, constraintSolver:ConstraintSolver, collisionConfiguration:CollisionConfiguration, softBodySolver:SoftBodySolver):SoftRigidDynamicsWorld return untyped bullet._eb_btSoftRigidDynamicsWorld_new5(dispatcher, pairCache, constraintSolver, collisionConfiguration, softBodySolver);
    public inline function new(dispatcher:Dispatcher, pairCache:BroadphaseInterface, constraintSolver:ConstraintSolver, collisionConfiguration:CollisionConfiguration, softBodySolver:SoftBodySolver):Void this = new5(cast dispatcher, cast pairCache, cast constraintSolver, cast collisionConfiguration, cast softBodySolver);
    inline public function addSoftBody(body:SoftBody, collisionFilterGroup:Int, collisionFilterMask:Int):Void return untyped bullet._eb_btSoftRigidDynamicsWorld_addSoftBody3(this, body, collisionFilterGroup, collisionFilterMask);
    inline public function removeSoftBody(body:SoftBody):Void return untyped bullet._eb_btSoftRigidDynamicsWorld_removeSoftBody1(this, body);
    inline public function removeCollisionObject(collisionObject:CollisionObject):Void return untyped bullet._eb_btSoftRigidDynamicsWorld_removeCollisionObject1(this, collisionObject);
    inline public function getWorldInfo():SoftBodyWorldInfo return untyped bullet._eb_btSoftRigidDynamicsWorld_getWorldInfo0(this);
    inline public function getSoftBodyArray():SoftBodyArray return untyped bullet._eb_btSoftRigidDynamicsWorld_getSoftBodyArray0(this);
    inline public function delete():Void return untyped bullet._eb_btSoftRigidDynamicsWorld_delete(this);
    @:to
    inline function _toDiscreteDynamicsWorld():DiscreteDynamicsWorld return cast this;
