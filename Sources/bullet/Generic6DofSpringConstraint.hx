...
#if hl
abstract Generic6DofSpringConstraint(webidl.Types.Ref) to webidl.Types.Ref {
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_new5")
    static function new5(rbA:RigidBody, rbB:RigidBody, frameInA:Transform, frameInB:Transform, useLinearFrameReferenceFrameA:Bool):Generic6DofSpringConstraint return null;
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_new3")
    static function new3(rbB:RigidBody, frameInB:Transform, useLinearFrameReferenceFrameB:Bool):Generic6DofSpringConstraint return null;
    ...
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_enableSpring2")
    public function enableSpring(index:Int, onOff:Bool):Void { }
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_setStiffness2")
    public function setStiffness(index:Int, stiffness:Single):Void { }
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_setDamping2")
    public function setDamping(index:Int, damping:Single):Void { }
    @:hlNative("bullet", "btGeneric6DofSpringConstraint_delete")
...
#elseif js
abstract Generic6DofSpringConstraint(webidl.Types.Ref) to webidl.Types.Ref {
    inline static function new5(rbA:RigidBody, rbB:RigidBody, frameInA:Transform, frameInB:Transform, useLinearFrameReferenceFrameA:Bool):Generic6DofSpringConstraint return untyped bullet._eb_btGeneric6DofSpringConstraint_new5(rbA, rbB, frameInA, frameInB, useLinearFrameReferenceFrameA);
    inline static function new3(rbB:RigidBody, frameInB:Transform, useLinearFrameReferenceFrameB:Bool):Generic6DofSpringConstraint return untyped bullet._eb_btGeneric6DofSpringConstraint_new3(rbB, frameInB, useLinearFrameReferenceFrameB);
    public inline function new(rbA_rbB:RigidBody, rbB_frameInB:haxe.extern.EitherType<RigidBody, Transform>, frameInA_useLinearFrameReferenceFrameB:haxe.extern.EitherType<Transform, Bool>, ?frameInB:Transform, ?useLinearFrameReferenceFrameA:Bool):Void if (frameInB == null) this = new3(cast rbA_rbB, cast rbB_frameInB, cast frameInA_useLinearFrameReferenceFrameB) else this = new5(cast rbA_rbB, cast rbB_frameInB, cast frameInA_useLinearFrameReferenceFrameB, cast frameInB, cast useLinearFrameReferenceFrameA);
    inline public function enableSpring(index:Int, onOff:Bool):Void return untyped bullet._eb_btGeneric6DofSpringConstraint_enableSpring2(this, index, onOff);
    inline public function setStiffness(index:Int, stiffness:Float):Void return untyped bullet._eb_btGeneric6DofSpringConstraint_setStiffness2(this, index, stiffness);
    inline public function setDamping(index:Int, damping:Float):Void return untyped bullet._eb_btGeneric6DofSpringConstraint_setDamping2(this, index, damping);
